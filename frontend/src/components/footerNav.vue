<template>
	<section id="sectionFooter">
		<div class="navIcon" id="NavHomeIcon">
			<svg
		...
		<div class="navIcon" id="NavBudgetsIcon">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="40px"
				height="40px"
		...
		<div class="navIcon" id="NavAddIcon">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="800px"
				height="800px"
		...
		<div class="navIcon" id="NavScanIcon">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="800px"
				height="800px"
		...
		<div class="navIcon" id="NavSettingsIcon">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="800px"
				height="800px"
