...
exports.getTransaction = (async (req, res) => {
  ...
  try {
    const transaction = await transactionModel.find({transcactionId: transcationId});
...
exports.createTransaction = (async(req, res) => {
    const { transactionAccountId, transactionNote, transactionAmount, transactionImage, transactionReurring, transactionDate } = req.body;
...
exports.updateTransaction = (async(req, res) => {
  ...
  try {
      await transactionModel.updateOne({ transactionAccountId: inputTransactionAccountId}, {
        transactionNote: inputTransactionNote,
        transactionAmount: inputTransactionAmount,
        transactionImage: inputTransactionImage,
        transactionRecurring: inputRransactionRecurring,
      ...
      const updatedTransaction = await transactionModel.find({ transactionAccountId: inputTransactionAccountId});
...
exports.deleteTransaction = (async(req, res) => {
    const { transactionAccountId } = req.params;
    try {
        const deletedBook = await transactionModel.deleteOne({ transactionAccountId: inputTransactionAccountId});
